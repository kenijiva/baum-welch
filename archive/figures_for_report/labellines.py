...
#
# The code in this file contains minor changes to the original available at:
# https://github.com/cphyc/matplotlib-label-lines/blob/master/labellines/core.py
#
# We use this functions to label our plots for the report
#
...
def labelLine(line, x, label=None, align=True, drop_label=False, **kwargs):
    ...
    ax.text(x, y, label, rotation=rotation, bbox=dict(facecolor=ax.get_facecolor(), edgecolor=line.get_color(), linewidth=3), **kwargs)
